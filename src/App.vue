<template>
  <div>
    ...
    <game onmousedown="return false" :wait="wait" :mousePosition="mousePosition" :avatars="avatars" :myAvatar="myAvatar" :halfHeight="halfHeight" :halfWidth="halfWidth" :target="target" :foods="foods" :hOFs="hOFs" :ranking="ranking" :mapSize="mapSize" :mapResize="mapResize"
...
Vue.use(VueSocketio, 'http://10.41.163.59:3000/')
